...
type Order struct {
	...
	StaffUserID primitive.ObjectID `json:"staff_user_id,omitempty" bson:"staff_user_id,omitempty"`
	GuestUserID primitive.ObjectID `json:"guest_user_id,omitempty" bson:"guest_user_id,omitempty"`
